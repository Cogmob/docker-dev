...
" HTML
let g:formatdef_htmlbeautify = '"html-beautify -f - -s ".&shiftwidth -w ".&textwidth'
let g:formatdef_tidy_html = '"tidy -q --show-errors 0 --show-warnings 0 --force-output --indent auto --indent-spaces ".&shiftwidth." --vertical-space yes --tidy-mark no -w ".&textwidth'
